...
```
	 ...
	 * 
	 ***************************************************************************/
	public PFRHttpResponse doLogin(PFRDataRecord data) throws ResponseFailedException {
	 ...
	 * 
	 ***************************************************************************/
	public PFRHttpResponse openDashboard(PFRDataRecord data) throws ResponseFailedException {
		return PFRHttp.create(...
	}
```
